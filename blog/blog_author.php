<?php
	...
	$mysql->getPage('blog', '', "where blogauthor = '$author' order by blogviews desc", $pagesize);
	...
	$sql="select * from blog where blogauthor = '$author' order by blogviews desc limit $offset,$pagesize";
