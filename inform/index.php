	...
	<div id="main-content">
		<div id="sidebar">
			<div id="gadget">
				...
				?>
				<p><a href="detailInform.php?id=<?php echo $row_notice[id] ?>"><?php echo $row_notice[title]; ?></a><span>&nbsp;[<?php echo $row_notice[readtimes]; ?>]</span></p>
				<?php
				}
				?>
			...
			?>
				<div class="post">
					<div class="ct"><div class="l"><div class="r"></div></div></div>
						<h2 class="title"><a href="detailInform.php?id=<?php echo $row[id] ?>"><?php echo $row[title]; ?><?php if($count <= 3) echo "<sup style=\"color:RGB(214,71,41)\">new!</sup>"; ?></a></h2>
						<p class="byline">发表时间:<?php echo $row[date]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 发表人:<?php echo $row[author]; ?></p>
						<div class="entry">
							<blockquote>
								<?php
									echo strip_tags(substr(($row[content]), 0, 201)) . "......";
								?>
							</blockquote>
						</div>
						<p class="endline"><a href="detailInform.php?id=<?php echo $row[id] ?>">阅读全文</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 阅读次数:(<?php echo $row[readtimes]; ?>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
