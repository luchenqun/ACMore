<?php
	...
	$sql = "UPDATE `notification` SET `readtimes` = `readtimes` + 1 WHERE `id` = '$id'";//阅读次数加1
	$mysql->query($sql);	
?>
		...
		<div id="content" style = "margin-left: 0px;">
			<div class="post">
				<div class="ct"><div class="l"><div class="r"></div></div></div>
					...
					<p class="byline">发表时间:<?php echo "$arr[date]"; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 发表人:<?php echo "$arr[author]"; ?></p>
					...
					<br />
						...
						<!-- UY END -->					
					<br /><p align=right><a href="javascript:window.history.back(-1)">返回&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></p></div>
					<p class="endline"></p>
					<p class="endline"></p>
