<?php
	...
	$mysql->getPage('fileinfo', '', 'order by fileid desc', $pagesize);
	...
	$sql="select * from fileinfo order by fileid desc limit $offset,$pagesize";
...
<div id="body-wrapper">
    <div id="main-content">
		...
		<div id="footer" style="height:400px"><center><small>&#169; Copyright 2012 CSUST | Powered by <a href="#">泥巴</a> | <a href="#">Top</a> </small></center></div>
    </div>
</div>
</body>
</html>
