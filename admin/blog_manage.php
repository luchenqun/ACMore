<?php
	...
	$mysql->getPage('blog', '', "order by blogid desc", $pagesize);
	...
	$sql="select * from blog order by blogid desc limit $offset,$pagesize";
						...
						?>
						  <tr>
							...
							<td>
								...
								<?php echo "<a href=\"blog_delete.php?userNo=$row[blogid]\" title=\"删除\" onclick=\"if(confirm('确实要删除此条记录吗,删除后数据无法恢复？')) return true;else return false; \" ><img src=\"resources/images/icons/cross.png\" alt=\"Delete\" /></a> "; ?>
							</td>
						  </tr>
						 <?php }
						 ?>
